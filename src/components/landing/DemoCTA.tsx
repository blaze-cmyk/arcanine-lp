...
const SlotReel = ({ target, delay }: { target: number; delay: number }) => {
  ...
  const containerH = 280; // shows ~2.3 digits worth
      ...
      >
        {strip.map((d, i) => {
          ...
          return (
            ...
            >
              <span
                className={`text-[88px] sm:text-[104px] font-bold font-display leading-none select-none transition-all duration-500 ${colorClass}`}
              >
                {d}
              </span>
            </div>
...
const ReelSeparator = () => (
  <div className="flex flex-col items-center justify-center h-[280px] w-[1px] relative z-10">
    <div
    ...
    <section className="py-32 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
        ...
        >
          ...
          {/* Dollar sign */}
          <div className="flex items-center relative z-10 mr-1" style={{ height: 280 }}>
            <span className="text-[88px] sm:text-[104px] font-bold font-display leading-none select-none text-transparent bg-clip-text bg-gradient-to-b from-[#E8A94A] via-[#D4892A] to-[#A05E12]">
              $
            </span>
          </div>
          ...
          <div className="flex items-center relative z-10">
            {isVisible
              ...
              : targets.map((_, i) => (
                  <div key={i} style={{ width: 80, height: 280 }} />
                ))}
          </div>
        </div>
