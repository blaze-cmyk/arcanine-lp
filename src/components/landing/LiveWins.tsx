        ...
        >
          {wins.map((win, index) => (
            <div
              ...
              className={`relative flex-shrink-0 w-[140px] rounded-xl bg-gradient-to-b ${win.color} className={`relative flex-shrink-0 w-[140px] rounded-xl bg-gradient-to-b ${win.color} p-3 backdrop-blur-sm transition-all duration-300 ${ p-3 backdrop-blur-sm transition-all duration-300 ${
