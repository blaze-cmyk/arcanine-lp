      ...
      <div className="rounded-2xl transition-all duration-300">
        <div className="flex items-center justify-between h-14 px-5">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <button className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-foreground/80 hover:text-foreground bg-secondary-btn rounded-lg transition-colors duration-200">
