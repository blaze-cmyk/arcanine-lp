      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div
            ...
            style={{
              background: "radial-gradient(ellipse 80% 70% at 50% 100%, rgba(0,255,136,0.25) 0%, rgba(0,255,136,0.12) 30%, rgba(0,255,136,0.04) 60%, transparent 100%)",
            }}
          />
          <div
            className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[60%] h-[35%] pointer-events-none z-0 blur-2xl"
            style={{
              background: "radial-gradient(ellipse at 50% 100%, rgba(0,255,136,0.3) 0%, rgba(0,255,136,0.1) 50%, transparent 100%)",
            }}
          />
          <div
            className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[40%] h-[20%] pointer-events-none z-0 blur-xl"
            style={{
              background: "radial-gradient(ellipse at 50% 100%, rgba(0,255,136,0.25) 0%, transparent 80%)",
            }}
          />
