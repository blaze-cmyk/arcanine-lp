...
const TradeInSecondsVisual = () => {
  ...
  return (
    <div className="relative w-full h-full flex items-start justify-center px-5 pt-3 pb-1">
      <div
      ...
      >
        {/* Investment */}
        <div className="px-2.5 pt-2 pb-1.5 border-b border-border/50">
          <fieldset className="border border-border/60 rounded-md px-2 pb-1 pt-0">
            <legend className="text-[9px] text-muted-foreground font-medium px-1">Investment</legend>
        ...
        <div className="px-2.5 py-2 border-b border-border/50">
          <div className="flex items-center justify-between">
            <span className="text-[10px] text-muted-foreground font-medium">Your payout</span>
            <span className="text-[9px] text-profit font-bold">{PAYOUT_PCT}% return</span>
          </div>
          <div className="flex items-center justify-center pt-0.5">
            <span className="text-xl font-extrabold tracking-tight text-foreground tabular-nums">
              {payout}
            </span>
            <span className="text-base font-bold text-profit ml-1">$</span>
          </div>
        </div>
        ...
        <div className="p-1.5 space-y-1">
          <button
            className="w-full flex items-center justify-between px-2.5 py-1.5 rounded-md font-bold text-xs transition-transform hover:scale-[1.01]"
            style={{ background: "hsl(var(--profit))", color: "#0a0a0a" }}
          >
            <span>Up</span>
            <ArrowUp size={14} />
          </button>
          <button
            className="w-full flex items-center justify-between px-2.5 py-1.5 rounded-md font-bold text-xs transition-transform hover:scale-[1.01]"
            style={{ background: "hsl(var(--loss))", color: "#fff" }}
          >
            <span>Down</span>
            <ArrowDown size={14} />
          </button>
