  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-start overflow-hidden pt-28 sm:pt-32">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        {/* Top badge */}
        <div className="animate-slide-up inline-flex items-center gap-3 mb-6 pl-1.5 pr-5 py-1.5 rounded-full border border-border/40 bg-card/60 backdrop-blur-sm">
