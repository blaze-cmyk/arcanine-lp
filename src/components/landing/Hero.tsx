...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-start overflow-hidden px-4 pt-20 sm:pt-24">
      {/* Content */}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto mt-20 animate-slide-up-delay-4">
